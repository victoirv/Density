...
In this work, events are defined to occur when $D_{st}$ or $\rho_{eq}$ crosses a threshold value, as indicated by horizontal dashed lines in their respective panels of Figure~\ref{AllData}.  \vinote{need to put line in rho_eq plot.}
