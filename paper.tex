...
\cite{Takahashi2006} estimated magnetospheric mass density using measurements from the CRRES satellite during a 73-day period and 1991 and found that the average ion mass density, $M=\rho/n_e$, depended on geomagnetic activity, with lower $D_{st}$ values corresponding to slightly average ion mass densities.  They also found a $K_p$ dependence between the average ion mass and 1.5- and 3-day averages of $K_p$ were compared to $M$.  Most measurements occurred in the MLT range of 12:00 and 18:00 MLT in the plasma trough (in equatorial plane?)

\cite{Takahashi2010} developed a mass density dataset using measurements from the GOES satellites over the years 1980 through 1992, with most measurements in the range $L=6.8\pm0.2$ The equatorial mass density, $\rho_eq$ was estimated from the estimated mass density a power law dependence on the geocentric radius $R$, $\rho=\rho_{eq}(LR_E/R)$. A key result was that when daily-averaged measurements were considered, an enhancment in $\rho_{eq}$ appeared, indicating the possibility of a geomagnetic storm control over $\rho_{eq}$.
...
The results of \cite{Takahashi2006} and \cite{Takahashi2010} are consistent with other results on changes in mass density in the plasma trough region.  \cite{Hamilton1988} ... \cite{Gallagher1988} .... \cite{Yao2008} studied the relationship between $D_{st}$ and ion number density for different ions in different regions (ring current and plasma sheet) and found a general correlation during each of the four storms considered.
...
\begin{figure}[htp]
\centering
\includegraphics[scale=0.45]{paperfigures/blockmedian.eps}
\includegraphics[scale=0.45]{paperfigures/blockmedian-prenoon.eps}
