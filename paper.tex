...
\begin{figure}[htp!]
\centering
\includegraphics[scale=0.5]{paperfigures/stormavs-dst-day.eps}
\includegraphics[scale=0.5]{paperfigures/stormavs-dst-27day.eps}
\caption{One-day and 27-day averaged $D_{st}$ storms}
\label{DailyAverages}
\end{figure}
\clearpage
...
\begin{figure}[htp!]
\centering
\includegraphics[scale=0.5]{paperfigures/stormavs-dst-day-nof107.eps}
\includegraphics[scale=0.5]{paperfigures/stormavs-dst-27day-nof107.eps}
\caption{One-day and 27-day averaged $D_{st}$ storms with $F_{10.7}$ dependence removed}
\label{DailyAveragesNoF107}
\end{figure}
\clearpage
