...
\begin{figure}[htp!]
\centering
\subcaptionbox{All data of $F_{10.7\_27d}$ and $\rho_{eq\_27d}$ \label{ccplot:a}}
{\includegraphics[scale=0.42]{paperfigures/F107MDAllData.eps}}
\subcaptionbox{ Correlation between $log(\rho_{eq\_27d})$ and $F_{10.7\_27d}$, compare to \cite{Takahashi2010} Fig. 14  \label{ccplot:b}}
{\includegraphics[scale=0.42]{paperfigures/ccplot.eps}}
\subcaptionbox{$D_{st}$ against $\rho_{eq}$ at one hour and one-day median values. \label{ccplot:c}}
