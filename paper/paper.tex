...
These tests indicate that there is not a statistically significant difference in medians of $\rho_{eq}$ on the day before and day after a threshold crossing in $D_{st}$.  In addition, the observed differences are on the order of only 10\% of the value of $\rho_{eq}$ on the onset day, which is similar to the variation in the observations over the displayed epoch time interval.  
...
\begin{figure}[tp!]
  \centering
  \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF107-case1-t020-tf25-GOES6.eps}
  \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF107-case1-t025-tf30-GOES6.eps}
