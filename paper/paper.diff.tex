...
%DIF DEL paper.old   Tue Oct 18 12:00:40 2016
%DIF ADD paper.tex   Tue Oct 18 12:53:56 2016
%\usepackage{graphicx}
%\usepackage{fancyhdr}
...
Work at Dartmouth College was supported by NSF grant AGS-1105790\DIFaddbegin \DIFadd{. 
}\DIFaddend 

\DIFaddbegin \DIFadd{The mass density data used for this work can be obtained from }\url{http://www.dartmouth.edu/~rdenton} \DIFadd{and the gap-filled solar wind data is available at }\url{http://virbo.org/ftp/users/kondrashov/}\DIFadd{.
}
...
\begin{figure}[htp!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.45]{figures/alldata-GOES6-1983-1991.eps}
%DIFDELCMD < %%%
...
\begin{figure}[htp!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/F107MD27d-GOES6.eps}
%DIFDELCMD < \includegraphics[scale=0.40]{figures/ccplot-GOES6.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p02a.eps}
\includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p02b.eps}
\DIFaddendFL \caption{Top: 27-day non-overlapping medians of $F_{10.7}$ and $\log_{10}(\rho_{eq})$ from GOES 6. Bottom: Scatter plot of $\log_{10}(\rho_{eq})$ and $F_{10.7}$ using medians in non-overlapping hour, day, and 27-day windows.}
\label{fig:ccplot}
\end{figure}
\clearpage
...
\begin{figure}[h]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/stormavs-dst-50-tak-GOES6.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p03a.eps}
\DIFaddendFL \\
\rule[1ex]{5cm}{1pt}
\\
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/stormavs-dst-day-GOES6.eps}
%DIFDELCMD < %%%
...
\begin{figure}[tp!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/stormavs-dd12-GOES6.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p04a.eps}
\DIFaddendFL \\
\rule[1ex]{5cm}{1pt}
\\
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/stormavs-dst-GOES6.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p04b.eps}
\DIFaddendFL \caption{$D_{st}$ events from GOES 6 using hourly medians. Top: Events with the constraint that $D_{st}$ stayed below $-50$~nT for at least 12~hours after crossing below $-50$~nT.  Bottom: Same as Top except without constraint.}
...
\begin{figure}[tp!]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedB_z-case1-t020-tf25-GOES6.eps}
%DIFDELCMD <   \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedB_z-case1-t025-tf30-GOES6.eps}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p05a.eps}
  \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p05b.eps}
  \DIFaddendFL \caption{$D_{st}$ events of the bottom panel of Figure~\ref{fig:HourlyAveragedDstEvents} separated by the average $D_{st}$ value (a) at onset and four hours before, and (b) at onset and four hours after.}
  \label{fig:BzBinnedDstEvents}
\end{figure}

\begin{figure}[tp!]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF_{10.7}-case1-t020-tf25-GOES6.eps}
%DIFDELCMD <   \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF_{10.7}-case1-t025-tf30-GOES6.eps}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p06a.eps}
  \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p06b.eps}
  \DIFaddendFL \caption{$D_{st}$ events of the bottom panel of Figure~\ref{fig:HourlyAveragedDstEvents} separated by the average $F10.7$ value (a) at onset and four hours before, and (b) at onset and four hours after.}
...
\begin{figure}[htp!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/stormavs-mass-gt20-GOES6.eps}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p07.eps}
\DIFaddendFL \caption{$\rho_{eq} >$ 20~amu/cm$^3$ events from GOES 6 using hourly medians.}
...
\begin{figure}[tp!]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedB_z-case24-t020-tf25-GOES6.eps}
%DIFDELCMD <   \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedB_z-case24-t025-tf30-GOES6.eps}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p08a.eps}
  \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p08b.eps}
  \DIFaddendFL \caption{$\rho_{eq}$ events of Figure~\ref{fig:HourlyAveragedRhoEvents} separated by the average $B_z$ value (a) at onset and four hours before, and (b) at onset and four hours after.}
  \label{fig:BzBinned}
\end{figure}

\begin{figure}[tp!]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF_{10.7}-case24-t020-tf25-GOES6.eps}
%DIFDELCMD <   \includegraphics[scale=0.40]{figures/RhoBinned/RhoBinnedF_{10.7}-case24-t025-tf30-GOES6.eps}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p09a.eps}
  \includegraphics[scale=0.40]{UsedFigures/2016SW001507R-p09b.eps}
  \DIFaddendFL \caption{$\rho_{eq}$ events of Figure~\ref{fig:HourlyAveragedRhoEvents} separated by the average $F10.7$ value (a) at onset and four hours before, and (b) at onset and four hours after.}
